  ...
  return (
    <section
      ...
      <div className="container mx-auto py-60 flex-col font-bold">
        ...
        <a href= "./Assets/ChindujaResume.pdf" download className = "font-Fira text-xl flex justify-center content-center bg-purple-500 w-28 mx-auto border-3 rounded transform hover:scale-110">My Cv </a>
        </div>
